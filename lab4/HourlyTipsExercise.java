...
public class HourlyTipsExercise extends ExerciseBase {
	...
	public static void main(String[] args) throws Exception {
		...
		DataStream<Tuple3<Long, Long, Float>> hourlyTips = fares
				...
				.reduce(new TipReducer(), new TipWindowFunction());
	...
	public static class TipReducer implements ReduceFunction<TaxiFare> {
		@Override
	...
	public static class TipWindowFunction
		...
		public void process(
			...
			TaxiFare summedFare = fares.iterator().next();
			out.collect(new Tuple3<>(ctx.window().getEnd(), driverId, summedFare.tip));
		}
	}
